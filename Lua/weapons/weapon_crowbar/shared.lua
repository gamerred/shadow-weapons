...
SWEP.Contact = "gamerredx@gmail.com"
SWEP.Purpose = "Throw chairs."
SWEP.Instructions = "left click and right click to throw chairs"
...
SWEP.Category = "Shadow-Weapons-Objects-Thrower"
